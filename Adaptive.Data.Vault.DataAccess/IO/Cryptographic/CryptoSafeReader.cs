...
namespace Adaptive.Data.Vault.DataAccess.IO.Cryptographic
{
    /// <summary>
    ...
    public sealed class CryptoSafeReader : ExceptionTrackingBase, ISafeReader
    {
        ...
        /// </param>
        /// <param name="userId">
        /// A string containing the user id / name for the file.
        /// </param>
        ...
        /// <summary>
        /// Reads a <see cref="T:System.Guid" /> value from the data source.
        /// </summary>
        /// <returns>
        /// The <see cref="T:System.Guid" /> value that was read, or <b>Guid.Empty</b> on failure.
        /// </returns>
        public Guid ReadGuid()
        {
            ...
            if (_reader != null)
            {
                if (_reader.CanRead)
                {
                    ...
                    {
                        // Read null indicator.
                        byte[]? isNull = _reader.ReadBytes();
                        if (isNull != null && isNull.Length == 1 && isNull[0] == 1)
                        {
                            byte[]? guidBytes = _reader.ReadBytes();
                            if (guidBytes != null)
        ...
        /// <summary>
        /// Reads a <see cref="USPhoneNumber" /> instance from the data source.
        /// </summary>
        /// <returns>
        /// The <see cref="USPhoneNumber" /> instance that was read, or <b>null</b>.
        /// </returns>
