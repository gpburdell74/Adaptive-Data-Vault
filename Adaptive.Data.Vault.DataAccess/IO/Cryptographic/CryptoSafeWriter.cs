...
namespace Adaptive.Data.Vault.DataAccess.IO.Cryptographic
{
    ...
    public sealed class CryptoSafeWriter : ExceptionTrackingBase, ISafeWriter
    {
        ...
        /// <summary>
        /// Gets the reference to the base stream the writer is acting on.
        /// </summary>
        /// <value>
        ...
        /// <summary>
        /// Writes the specified <see cref="Guid" /> value or NULL to the data source.
        /// </summary>
        /// <param name="value">The <see cref="Guid" /> value to be written, or <b>null</b>.</param>
        /// <returns>
        /// <b>true</b> if the operation is successful; otherwise, returns <b>false</b>.
        /// </returns>
        /// <remarks>
        ...
        public bool Write(Guid? value)
        {
            ...
            if (_writer != null)
            {
                if (_writer.CanWrite)
                {
                    ...
                    if (success && value != null)
                    {
                        byte[] guidBytes = value.Value.ToByteArray();
                        _writer.Write(guidBytes);
                        success = true;
                    }
                }
            }
        ...
        #region Public Methods / Functions
        /// <summary>
        /// Disconnects the current object from the underlying stream without closing or
