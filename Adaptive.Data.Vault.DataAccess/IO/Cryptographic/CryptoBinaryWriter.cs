using Adaptive.Data.Vault.IO.Cryptographic;
...
namespace Adaptive.Data.Vault.DataAccess.IO.Cryptographic
{
    ...
    public sealed class CryptoBinaryWriter : DisposableObjectBase, ICryptoCompatibleObject
    {
        ...
        /// <summary>
        /// Encrypts the specified Date/Time value then writes the result to the output stream.
        /// </summary>
        /// <remarks>
        ...
        /// in order to compare with each other.
        /// </summary>
