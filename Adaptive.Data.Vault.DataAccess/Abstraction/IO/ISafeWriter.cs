...
/// <summary>
/// Provides the signature definition for implementing a safe writer object that tracks its own exceptions.
/// </summary>
...
public interface ISafeWriter : IExceptionTracking
{
    ...
    /// </summary>
    /// <param name="value">
    /// The <see cref="Guid"/> value to be written, or <b>null</b>.
    /// </param>
    /// <remarks>
    /// This method will write a NULL indicator value before the data value.
    /// </remarks>
