...
/// <summary>
/// Provides the signature definition for implementing a safe reader object that tracks its own exceptions.
/// </summary>
/// <seealso cref="IExceptionTracking" />
public interface ISafeReader : IDisposable 
{
    ...
    /// <summary>
    /// Reads a <see cref="Guid"/> value from the data source.
    /// </summary>
    /// <returns>
    /// The <see cref="Guid"/> value that was read, or <b>Guid.Empty</b> on failure.
    /// </returns>
    Guid ReadGuid();
