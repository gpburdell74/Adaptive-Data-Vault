...
{
    public partial class TextToHexDialog : AdaptiveDialogBase
    {
        #region Constructor / Dispose Methods
        /// <summary>
        /// Initializes a new instance of the <see cref="TextToHexDialog"/> class, setting up the user interface components and preparing the dialog for user interaction.
        /// </summary>
        /// <remarks>
        /// This is the default constructor.
        /// </remarks>
        public TextToHexDialog()
        {
            InitializeComponent();
        }
        /// <summary>
        ...
        private void HandleConvertClicked(object? sender, EventArgs e)
        {
            ...
            try
            {
                ...
                byte[] textData = System.Text.Encoding.UTF8.GetBytes(originalText);
                string hexEncoded = Convert.ToHexString(textData, 0, textData.Length);
                ResultText.Text = hexEncoded;
            }
            catch (Exception ex)
            {
                ExceptionLog.LogException(ex);
                ShowError("Conversion Error", "Could not convert the text content into hexadecimal format.");
            }
        ...
        private void HandleCopyClicked(object? sender, EventArgs e)
        {
            ...
            if (ResultText.Text.Length > 0)
            {
                try
                {
                    ...
                    ttp.Show("Hexadecimal text copied to clipboard.", CopyButton, 0, -20, 2000);
                }
                catch
                {
