...
/// <summary>
/// Provides a dialog for adding a new or editing an existing category.
/// </summary>
/// <seealso cref="AdaptiveDialogBase" />
public partial class AddEditCategoryDialog : AdaptiveDialogBase
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="AddEditCategoryDialog"/> class.
    /// </summary>
    /// <remarks>
    ...
    /// The reference to the <see cref="UserCategory"/> instance to edit.
    /// </param>
    public AddEditCategoryDialog(UserCategory categoryToEdit)
    {
        InitializeComponent();
    ...
    {
        get => CategoryEdit.Category;
        set
        {
            _category = value;
            CategoryEdit.Category = _category;
            Invalidate();
        }
    }
    #endregion
