namespace Adaptive.Data.Vault.UI
{
    partial class HexToTextDialog
    {
        ...
        private void InitializeComponent()
        {
            ...
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(HexToTextDialog));
            ContainerPanel = new Adaptive.Intelligence.Shared.UI.TemplatedGradientPanel();
            ClearButton = new Adaptive.Intelligence.Shared.UI.TemplatedButton();
            ResultText = new TextBox();
            OriginalText = new TextBox();
            PromptLabel = new Label();
            ConvertButton = new Adaptive.Intelligence.Shared.UI.TemplatedButton();
            CopyButton = new Adaptive.Intelligence.Shared.UI.TemplatedButton();
            ...
            BorderPanel = new Adaptive.Intelligence.Shared.UI.TemplatedGradientPanel();
            ...
            ttp.SetToolTip(ResultText, "This is the converted text, ready to be copied to the clipboard.");
            // 
            // OriginalText
            // 
            ...
            ttp.SetToolTip(OriginalText, "Enter the text containing the hexadecimal representation to be converted here.");
            // 
            // PromptLabel
            // 
            ...
            ttp.SetToolTip(ConvertButton, "Click to convert the text on the left hexadecimal format.");
        ...
        private Intelligence.Shared.UI.TemplatedGradientPanel ContainerPanel;
        private Intelligence.Shared.UI.TemplatedButton ClearButton;
        private ToolTip ttp;
        ...
        private Intelligence.Shared.UI.TemplatedGradientPanel BorderPanel;
    }
}