...
{
    public partial class Base64ToTextDialog : AdaptiveDialogBase
    {
        #region Constructor / Dispose Methods
        /// <summary>
        /// Initializes a new instance of the <see cref="Base64ToTextDialog"/> class, setting up the user interface components and preparing the dialog for user interaction.
        /// </summary>
        /// <remarks>
        /// This is the default constructor for the <see cref="Base64ToTextDialog"/> class. It calls the <see cref="InitializeComponent"/> method to initialize the dialog's components, ensuring that all UI elements are properly set up before the dialog is displayed to the user.
        /// </remarks>
        public Base64ToTextDialog()
        {
            InitializeComponent();
        }
        /// <summary>
        ...
        private void HandleConvertClicked(object? sender, EventArgs e)
        {
            ...
            try
            {
                ...
                string decoded = System.Text.UTF8Encoding.UTF8.GetString(Convert.FromBase64String(originalText));
                ResultText.Text = decoded;
            }
            catch (Exception ex)
            {
                ExceptionLog.LogException(ex);
                ShowError("Conversion Error", "Could not convert the text content from base-64 format.");
            }
