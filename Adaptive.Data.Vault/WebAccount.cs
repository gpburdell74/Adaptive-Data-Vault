...
/// <summary>
/// Represents and manages a user login account for a website.
/// </summary>
/// <seealso cref="VaultBusinessBase{T}" />
/// <seealso cref="IWebAccountEntity" />
public sealed class WebAccount : VaultBusinessBase<IWebAccountEntity>
{
    #region Constructors
    /// <summary>
    /// Initializes a new instance of the <see cref="WebAccount"/> class.
    /// </summary>
    /// <remarks>
    ...
    public WebAccount(IWebAccountEntity entity) : base(entity)
    {
    }
    #endregion
